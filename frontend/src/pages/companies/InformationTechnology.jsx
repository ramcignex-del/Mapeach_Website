  ...
  <section className="py-16 px-4 sm:px-6 lg:px-8 bg-slate-50">
    <div className="max-w-7xl mx-auto">
      <h2 className="text-3xl font-bold text-center text-slate-800 mb-12">
        Talent Focus: IT & Digital Transformation Expertise
      </h2>
            ...
            <CardContent className="p-6">
              ...
              <ul className="space-y-4">
                {category.items.map((item, idx) => (
                  <li key={idx}>
                    <p className="font-medium text-slate-800 mb-1">{item.role}</p>
                    <p className="text-sm text-slate-500">Skills: {item.skills.join(', ')}</p>
                  </li>
                ))}
              </ul>
            </CardContent>
              ...
              <tbody>
                {comparisonData.map((row, idx) => (
                  <tr key={idx}>
                    ...
                    <td className="px-6 py-4 text-sm text-center text-red-600">{row.traditional}</td>
