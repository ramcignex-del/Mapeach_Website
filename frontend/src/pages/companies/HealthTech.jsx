...
// Assuming you have this component for consistency
...
const HealthTech = () => {
  ...
  const [titleLine1, titleLine2] = pageText.hero.title.split('talent with deep industry expertise');
    ...
    <div ref={topRef} tabIndex={-1} className="min-h-screen outline-none">
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center max-w-4xl mx-auto">
            <h1 className="text-5xl md:text-6xl font-bold text-slate-900 leading-tight mb-6">
              ...
              <span className="block text-emerald-600 mt-2">talent with deep industry expertise</span>
            </h1>
      ...
      <section id="calculator" className="py-20 px-4 sm:px-6 lg:px-8 bg-slate-50">
        <div className="max-w-7xl mx-auto">
          ...
          {/* Placeholder for CostCalculator component */}
